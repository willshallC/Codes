            ...
            <td style="width: 560px;">
                ...
                <table style="width: 560px;text-align: center;margin: 0 auto;">
                    <thead>
                        ...
                        <tr>
                            <td class="text-center" style="font-size:25px; font-family: 'Lato', Arial, sans-serif;text-transform: uppercase;font-weight:normal;">New Backdate Entry Request</td>
                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left;font-size:15px;">
                                                <p style="margin:35px 0 25px;">A new backdate entry request is submitted by {{ $username }} on <a href="{{ url('/') }}" style="color:#346166;font-size:15px;font-style: italic;"> PMS.</a> Please verify and approve the <a href="{{ route('backdate-dsr-requests') }}" style="color:#346166;font-size:15px;font-style: italic;">request.</a></p>
                                            </td>
                                            <td style="width: 34px;"></td>
                                        </tr>
