            ...
            <td style="width: 560px;">
                ...
                <table style="width: 560px;text-align: center;margin: 0 auto;">
                    <thead>
                        ...
                        <tr>
                            <td class="text-center" style="font-size:25px; font-family: 'Lato', Arial, sans-serif;text-transform: uppercase;font-weight:normal;">List of employees who have not filled DSR(<?php echo $date; ?>)</td>
                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:left;font-size:16px;font-weight: 600;">
                                                ...
                                                <p style="margin:30px 0 5px;">These're the employees who didn't filled the PMS worksheet Yesterday:</p>
                                                    ...
                                                    @foreach($name as $user)
                                                     ...
                                                     ?>
                                                             <li style="font-weight: 100;">
                                                               <a href = "{{route('view-user', $user_id)}}" target="_blank"><?php  echo $username; ?></a>
                                                             </li>
