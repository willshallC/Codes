                ...
                <table style="width: 100%;text-align: center;margin: 0 auto;">
                    <thead>
                        ...
                        <tr style="height: 48px;">
                            <td>
                                <p style="margin: 60px 0 15px;"><img src="{{ asset('custom/images/tick-icon.png') }}"></p>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center" style="font-size:25px; font-family: 'Lato', Arial, sans-serif;text-transform: uppercase;font-weight:normal;">Registration Confirmation</td>
                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:left;font-size:16px;font-weight: 600;">
                                                <p style="margin:30px 0 5px;">Hi {{ $username }},</p>
                                            </td>
                                            <td style="width: 34px;"></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left;font-size:15px;">
                                                <p style="margin:35px 0 25px;line-height: 22px;">Your account is now approved and updated on<a href="{{ url('/') }}" style="color:#346166;font-size:15px;font-style: italic;"> PMS.</a>
                                                    <br>You can login to your account <a href="{{ url('/') }}/login" style="color:#346166;font-size:15px;font-style: italic;">here</a></p>
                                            </td>
                                            <td style="width: 34px;"></td>
                                        </tr>
