	...
	<div class="card-footer p-0 card-footer card-foote22 py-2">
        <div class="row">
			<div class="col-md-6" style="text-align: right;display:none">
				<strong>Total Paid : ${{$totalPaid->totatPaid}}</strong>
			</div>
			<div class="col-md-12" id="totalunpaid" style="text-align: center;display:none">
				<strong>Total Unpaid : ${{$totalUnpaid->totalUnpaid}}</strong>
			</div>
		</div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		jQuery(".col-sm-12.col-md-7").prepend('<div class="col-md-4" style="float: left;">'+jQuery('#totalunpaid').html()+'</div>');
    });
