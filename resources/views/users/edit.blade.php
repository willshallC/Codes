@extends('layouts.app', ['page' => __('Employee Management'), 'pageSlug' => 'edit-users'])
...
@section('content')
                        ...
                        <form method="post" action="{{ route('user.update', $user) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-0">
                               ...
                               <div class="text-center" style="text-align: left !important;margin: 0 0 20px;">
                                    <a href="{{ route('user.index') }}" type="button" class="btn btn-danger mt-4">{{ __('Cancel') }}</a>
 ...
 <a href="{{ route('user.index') }}" class="btn  btn-primary1">{{ __('Back') }}</a>
