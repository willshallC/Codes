...
<div class="table-date-content">
	...
	<div class="card-footer p-0 card-footer card-foote22 py-2">
		...
		<a class="btn  btn-primary1" href="{{ route('projects') }}" class="btn">Back</a>
		<a class="btn btn-success mt-4" href="{{ route('tl/edit-project',$project->id) }}" class="btn">Edit Information</a>
		<!-- <a class="btn btn-success mt-4" id="delete_project" href="javascript:void(0);">Delete Project</a> -->
	</div>
