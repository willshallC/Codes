...
@extends('employee.layouts.emp-app', ['page' => __('Employee Details'), 'pageSlug' => 'hr-users'])
...
<div class="row profile_employee">
	<div class="col-md-12">
		...
		<div class="card-footer p-0 card-footer py-2 nttt">
			...
			<a href="{{ route('hr/employees') }}" class="btn  btn-primary1">Back</a>
			<a href="{{ route('hr/edit-employee', $user->id) }}" class="btn">Edit Profile</a>
