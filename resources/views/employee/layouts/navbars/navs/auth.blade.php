            ...
            <ul class="navbar-nav ml-auto">
                <li class="search-bar input-group">
                    <div id="search-button">
                        <span class="d-lg-none d-md-block">{{ __('Start Searching') }}</span>
						
						 <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="{{ __('Start Searching') }}">
                ...
                <li class="dropdown nav-item">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <div class="photo">
                            <img src="{{ $image_path  }}{{ auth()->user()->profile_pic ?? 'employee.jpg' }}" alt="{{ __('Profile Photo') }}">
                        </div>
                    ...
                    <ul class="dropdown-menu dropdown-navbar">
                        <li class="nav-link">
                            <a href="{{ route('my-profile') }}" class="nav-item dropdown-item">{{ __('Profile') }}</a>
                        </li>
                        <li class="nav-link">
                ...
                <li class="header-welcome-text-emp">
